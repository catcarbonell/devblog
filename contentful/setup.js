...
const [NEXT_PUBLIC_CONTENTFUL_SPACE_ID, NEXT_PUBLIC_CONTENTFUL_ACCESS_TOKEN] = process.argv.slice(2)

if (!NEXT_PUBLIC_CONTENTFUL_SPACE_ID || !NEXT_PUBLIC_CONTENTFUL_ACCESS_TOKEN) {
  throw new Error(
    [
      'Parameters missing...',
...
spaceImport({
  ...
  managementToken: NEXT_PUBLIC_CONTENTFUL_ACCESS_TOKEN,
  content: exportFile,
})
